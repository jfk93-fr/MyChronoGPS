...
#   reads NMEA frames from MyVhronoGPS_Comm, parses them and sends a list in the NMEA pipe at each pulse
...
from MyChronoGPS_Comm import Comm
Comm = Comm();
...
class GpsControl(threading.Thread):
    ...
    def activateGPS(self):
        logger.debug("activateGPS="+str(self.GPSBlueTooth))
        ...
        while self.__running:
            ...
            if self.buffstate == FREE:
                ...
                try:
                    ...
                    logger.debug("decode failed:"+str(gpsline))
